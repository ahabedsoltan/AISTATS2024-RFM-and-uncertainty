...
You must use \texttt{aistats2024.sty} as a style file for your supplementary pdf file and follow the same formatting instructions as in the main paper. 
...
To submit your paper to AISTATS 2024, please follow these instructions.

\begin{enumerate}
    \item Download \texttt{aistats2024.sty}, \texttt{fancyhdr.sty}, and \texttt{sample\_paper.tex} provided in our starter pack. 
    ...
    \texttt{\textbackslash usepackage\{aistats2024\}}
    \end{flushleft}
...
\begin{enumerate}
    ...
    \begin{flushleft}
    \texttt{\textbackslash documentclass[twoside]\{article\}}\\
    \texttt{\textbackslash usepackage[accepted]\{aistats2024\}}
    \end{flushleft}
    The option \texttt{accepted} for the package
    \texttt{aistats2024.sty} will write a copyright notice at the end of
